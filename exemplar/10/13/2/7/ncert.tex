...
\item \textbf{Product:} Assuming all dice rolls and equally likely,:
    ...
    \end{align}
    \begin{figure}[h!]
        \includegraphics[width=0.4\columnwidth]{exemplar/10/13/2/7/plots/Apoorv_CDF.png}
...
\item \textbf{Square:}
    ...
    \end{align}
    \begin{figure}[h!]
        \includegraphics[width=0.4\columnwidth]{exemplar/10/13/2/7/plots/Peehu_PMF.png}
