...
\item \textbf{Product:} Assuming all dice rolls and equally likely,:
    ...
    \begin{align}
        ...
        &= \frac{1}{36} \label{eq:sriram_a1_3}
    \end{align}
...
\item \textbf{Square:}
    ...
    \begin{align}
        p_{Z^2}(36) = \frac{1}{6} \label{eq:sriram_a1_2}
    \end{align}
    \begin{figure}[h!]
    	\centering
    ...
    \end{figure}
\end{enumerate}
From \eqref{eq:sriram_a1_3} and \eqref{eq:sriram_a1_2}, $p_{Z^2}(36) > p_{XY}(36)$. Therefore, Peehu has a better chance of getting the number 36 than Apoorv.
