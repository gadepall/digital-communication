...
\item \textbf{Product:} Assuming all dice rolls and equally likely,:
    ...
    \begin{figure}[h!]
        \centering
	\includegraphics[width=\columnwidth]{exemplar/10/13/2/7/plots/Apoorv_PMF.png}
    ...
    \begin{figure}[h!]
    	\centering
        \includegraphics[width=\columnwidth]{exemplar/10/13/2/7/plots/Apoorv_CDF.png}
...
\item \textbf{Square:}
    ...
    \begin{figure}[h!]
    	\centering
        \includegraphics[width=\columnwidth]{exemplar/10/13/2/7/plots/Peehu_PMF.png}
    ...
    \begin{figure}[h!]
    	\centering
        \includegraphics[width=\columnwidth]{exemplar/10/13/2/7/plots/Peehu_CDF.png}
