...
\section{Answer}
\begin{itemize}
\item Number of red marbles = 5
\item Number of white marbles = 8
\item Number of green marbles = 4
\item Total marbles = 5+8+4 = 17
\end{itemize}
\begin{align}
\text {N} &= \text{R + W + G} \\
\text {n} &= \text{r + w + g}
\end{align}
Where R,B,G represent the total number of red, white and green marbles and r, b, g represent how many of them were picked respectively
\begin{align}
