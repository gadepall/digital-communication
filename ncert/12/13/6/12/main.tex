...
Suppose we have four boxes A,B,C and D containing coloured marbles as given in table below:
\begin{table}[htbp]
\centering
\input{tables/question_table.tex}
\caption{\label{table1}Question Table}
\end{table}
...
We can write,
\begin{align}
\pr{E}&= \sum_{i=1}^{i=4}{\pr{EE_i}}\label{eq:ncert/12/13/6/12/1}
\end{align}
Also,
\begin{align}
\pr{E|E_i}&=\frac{\pr{EE_i}}{\pr{E_i}}\label{eq:ncert/12/13/6/12/2}\\
\implies\pr{EE_i}&=\pr{E|E_i}\pr{E_i}\label{eq:ncert/12/13/6/12/3}
\end{align}
Now,


By \eqref{eq:ncert/12/13/6/12/2}
\begin{align}
\pr{E_1|E} &=\frac{\pr{EE_1}}{\pr{E}}
\end{align}
By \eqref{eq:ncert/12/13/6/12/3}
\begin{align}
\pr{E_1|E} &=\frac{\pr{E|E_1}\pr{E_1}}{\pr{E}}
\end{align}
By \eqref{eq:ncert/12/13/6/12/1} and \eqref{eq:ncert/12/13/6/12/3}
\begin{align}
