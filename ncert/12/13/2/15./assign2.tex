...
\textbf{Problem:}
\begin{enumerate}
\item One card is drawn at random from a well shuffled deck of 52 cards. In which of
...
\begin{enumerate}
	\item 
		...
		\begin{align}
			\pr{E} = \frac{^{13}C_1}{^{52}C_1} = \frac{13}{52}=\frac{1}{4} 
		\end{align}
		$F$ denotes the event that card drawn is ace 
		\begin{align}
			\pr{F} = \frac{^4C_1}{^{52}C_1} = \frac{4}{52}=\frac{1}{13}
		\end{align}
		 $EF$ denotes the event the card is spade and ace
		 \begin{align}
					\pr{EF} = \frac{^1C_1}{^{52}C_1} = \frac{1}{52}\\
			\pr{E}\pr{F} = \frac{1}{4} \times \frac{1}{13} = \frac{1}{52}\\
			\therefore\pr{EF} = \pr{E}\pr{F}
		\end{align}
		$\therefore$  $E$ and $F$ are independent events.
	\item $E$ denotes the event that the card drawn is black 
		\begin{align}
			\pr{E} = \frac{^{26}C_1}{^{52}C_1} = \frac{26}{52}=\frac{1}{2}
		\end{align}
		$F$ denotes the event that card drawn is a king 
		\begin{align}
			\pr{F} = \frac{^4C_1}{^{52}C_1} =\frac{4}{52} = \frac{1}{13}
		\end{align}
		$EF$ denotes the event the card is black and king 
			\begin{align}
			\pr{EF} = \frac{^2C_1}{^{52}C_1} =\frac{2}{52}= \frac{1}{26} \\
			\pr{E}\pr{F} = \frac{1}{2} \times \frac{1}{13} = \frac{1}{26}\\
			\therefore\pr{EF} = \pr{E}\pr{F}
		\end{align}
		
		$\therefore$  $E$ and $F$ are independent events. 
	\item $E$ denotes the event that the card drawn is king or queen
		\begin{align}
			\pr{E} = \frac{^8C_1}{^{52}C_1} = \frac{8}{52}= \frac{2}{13}
		\end{align}
		$F$ denotes the event that card drawn is a queen or jack 
		\begin{align}
			\pr{F} = \frac{^8C_1}{^{52}C_1} =\frac{8}{52} = \frac{2}{13}
		\end{align}
		$EF$ denotes the event the card is either a king or queen and either queen or jack
			\begin{align}
			\pr{EF} = \frac{^4C_1}{^{52}C_1}=\frac{4}{52}= \frac{1}{13}\\
